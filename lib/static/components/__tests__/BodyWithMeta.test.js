...
describe('BodyWithMeta', function () {
  ...
  test('when route is a redirect route', function () {
    var BodyWithMeta = (0, _BodyWithMeta.makeBodyWithMeta)({
      ...
      clientScripts: [_react2.default.createElement('script', { text: 'text/javascript', src: 'main.js' }), _react2.default.createElement('script', { text: 'text/javascript', src: 'bootstrap.js' })],
      ClientCssHash: function ClientCssHash() {
        return _react2.default.createElement(
          'style',
          null,
